// 八个位置
export enum ELocation{ 'lt', 't', 'rt', 'r', 'rb', 'b', 'lb', 'l' }
// 对应的手势
export enum ECursor { 'lt', 't', 'rt', 'r', 'rb', 'b', 'lb', 'l' }
// 对应手势的鼠标样式
export const CCursorStyle = ['nw-resize', 'n-resize', 'ne-resize', 'e-resize', 'se-resize', 's-resize', 'sw-resize', 'w-resize']
