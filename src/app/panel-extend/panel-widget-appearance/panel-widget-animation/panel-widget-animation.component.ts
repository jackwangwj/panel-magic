...
import { PanelAnimationModel, animationLabelDelayOptions, animationLabelDurationOptions, animationIterationCountOptions } from '../Model';
...
export class PanelWidgetAnimationComponent implements OnInit, OnDestroy {
	...
	constructor(
		...
		this.profileOuterSphereRX$ = this.panelScopeEnchantmentService.scopeEnchantmentModel.profileOuterSphere$.subscribe(value=>{
			if( value ) {
