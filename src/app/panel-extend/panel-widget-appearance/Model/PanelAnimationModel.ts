...
export class PanelAnimationModel extends BaseValueChangeClass<PanelAnimationModel> {
	...
	public get animationName() : string { return this._animationName; }
	...
	public get animationDelay() : string { return this._animationDelay; }
	...
	public get animationIterationCount() : string { return this._animationIterationCount; }
