...
@NgModule({
	...
	declarations: [PanelWidgetAppearanceComponent, PanelWidgetTextComponent, PanelWidgetFacadeComponent, PanelWidgetShadowComponent, ...panelSiteComponentList, PanelWidgetPictureComponent, PanelWidgetFilterComponent, PanelWidgetClipPathComponent, PanelWidgetAnimationComponent]
})
