...
export class MapViewComponent implements OnInit, OnDestroy {
	...
	public set autoWidget(v: PanelWidgetModel) {
		if (v['type'] != '') {
			...
			this.widgetModel.content.mapModel = new MapModel(
				v.autoWidget.content.mapModel
			)
	...
	public openValueChange(): void {
		if (this.autoWidget) {
			this.profileValueChangeRX$ = this.autoWidget.profileModel.valueChange$.subscribe(
				value => {
