...
export class PanelSeniorVesselStatusCollectionComponent implements OnInit {
	@ViewChild('editInputEl') public editInputEl: ElementRef
	...
	constructor(
		...
		private panelSeniorVesselStatusCollectionService: PanelSeniorVesselStatusCollectionService,
	...
	public checkStatus(status: VesselStatusCollectionModel ): void {
		this.panelSeniorVesselEditService.currentStatusInVesselInfo.widgetList = this.panelExtendService.handleSaveWidgetToOrientationModelData(this.panelSeniorVesselEditService.riverDiversionWidgetList$.value)
