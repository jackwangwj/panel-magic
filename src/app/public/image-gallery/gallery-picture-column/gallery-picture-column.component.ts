...
export class GalleryPictureColumnComponent implements OnInit, OnDestroy {
	...
	@ViewChild('editInputNameEl') private editInputNameEl: ElementRef;
	...
	constructor(
		...
		private galleryPictureColumnService: GalleryPictureColumnService
	) {
	...
	public acceptChangeManageMode(): void {
		...
		this.imageGalleryService.checkImageMap.forEach(_e => { _e.isActive = false });
